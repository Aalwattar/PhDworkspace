...
void print_DFG(void)
{
        ...
        do {
                ...
                printf ("T[%5lu] R[%5lu] Node [%3ld] -->%4d %1c%4d =%4d   Sim result [%s]  %s %2lu:%.3lu Exec %2lu:%.3lu PRR[%d] Reuse[%3s] Prio[%d] Type[%d] \r\n",
								(Sim.ExecTV.Value-GLOBAL_TV.Value)/100000 ,Sim.ConfigTV.Value? ((Sim.ConfigTV.Value-GLOBAL_TV.Value)/100000):0,
